...
/// E-mailsender die configuratie gebruikt (gebruik User Secrets of env voor wachtwoord).
public class SmtpEmailSender : IEmailSender
{
    ...
    // Nederlandse commentaar: verstuurt een eenvoudige HTML-e-mail via SMTP.
    public async Task SendEmailAsync(string email, string subject, string htmlMessage)
    {
        try
        {
            ...
            using var client = new SmtpClient(_opts.Host ?? "localhost", _opts.Port)
            {
...
public class SmtpOptions
{
    ...
    public string? Password { get; set; } // bewaar in User Secrets of environment variables
